"""
Shared base class for query optimization utilities.
...
class _BaseQueryOptimizer(ABC):
    """
    Shared static methods for query optimization.

    Do not instantiate this class directly. Use ``QueryOptimizer`` for async
    sessions or ``SyncQueryOptimizer`` for synchronous sessions.
    """

    @abstractmethod
    def execute_optimized_query(self, *args, **kwargs):
        """Execute the optimized query. Implemented by async and sync subclasses."""
        ...
