...
class SyncPaginator:
    """Enhanced pagination builder with performance optimizations and better error handling (Sync version).
    ...
    def _get_total_count(self, query: Select) -> int:
        ...
        try:
            ...
            result = self.session.scalar(count_query)
            count = result or 0
            ...
            return self._get_simple_count()

    def _get_simple_count(self) -> int:
